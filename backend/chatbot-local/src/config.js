...
export const CHATBOT_MAX_MESSAGE_CHARS = toPositiveNumber(
  process.env.CHATBOT_MAX_MESSAGE_CHARS,
  4000
);
export const CHATBOT_RATE_LIMIT_WINDOW_MS = toPositiveNumber(
  process.env.CHATBOT_RATE_LIMIT_WINDOW_MS,
  60000
);
export const CHATBOT_RATE_LIMIT_MAX_REQUESTS = toPositiveNumber(
  process.env.CHATBOT_RATE_LIMIT_MAX_REQUESTS,
  20
);
