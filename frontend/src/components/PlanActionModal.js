...
const PLAN_CONFIGS = {
  ...
  'A.5.3': {
    recommendations: [
      "Identifier toutes les tâches conflictuelles (développement/production, admin/utilisateur)",
      "Mettre en place des contrôles de supervision pour les tâches critiques",
      "Implémenter le principe du '4 yeux' pour les opérations sensibles",
      "Séparer les comptes d'administration des comptes utilisateurs",
      "Auditer annuellement la séparation des tâches effective"
    ],
    defaultSteps: [
      { title: "Analyse des conflits", desc: "Identifier les zones de conflit d'intérêts", completed: false },
      { title: "Redéfinition", desc: "Modifier l'organisation des tâches", completed: false },
      { title: "Contrôles techniques", desc: "Mettre en place les séparations dans les systèmes", completed: false },
      { title: "Audit", desc: "Vérifier l'efficacité des séparations", completed: false }
    ]
  },
  'A.5.4': {
    recommendations: [
  ...
  'A.5.31': {
    recommendations: [
      ...
      "Nommer un référent conformité (DPO, RSSI)",
  ...
  'A.6.4': {
    recommendations: [
      "Créer un règlement intérieur incluant les sanctions sécurité",
      "Définir une échelle de sanctions (avertissement, blâme, licenciement)",
      "Documenter tous les cas de non-conformité",
      "Impliquer les RH dans le processus disciplinaire",
      "Appliquer les sanctions de manière cohérente"
    ],
    defaultSteps: [
      { title: "Règlement", desc: "Mettre à jour le règlement intérieur", completed: false },
      { title: "Échelle", desc: "Définir les sanctions", completed: false },
      { title: "Processus", desc: "Documenter la procédure", completed: false },
      { title: "Formation", desc: "Former les managers", completed: false }
    ]
  },
  'A.6.5': {
  ...
  'A.7.8': {
    recommendations: [
      "Fixer les équipements sensibles (serveurs, baies)",
      "Protéger les câbles dans des goulottes",
      "Maintenir une température adaptée (18-27°C)",
      "Nettoyer régulièrement les équipements",
      "Surveiller l'humidité (40-60%)"
    ],
    defaultSteps: [
      { title: "Fixation", desc: "Sécuriser les équipements", completed: false },
      { title: "Goulottes", desc: "Protéger le câblage", completed: false },
      { title: "Environnement", desc: "Installer sondes température", completed: false },
  ...
  'A.7.12': {
    recommendations: [
      "Protéger le câblage dans des goulottes ou chemins fermés",
      "Étiqueter les câbles pour faciliter l'identification",
      "Interdire les câbles apparents",
      "Surveiller l'intégrité du câblage",
      "Utiliser des câbles blindés pour les zones sensibles"
    ],
    defaultSteps: [
      { title: "Audit", desc: "Inspecter câblage existant", completed: false },
      { title: "Correction", desc: "Protéger câbles non conformes", completed: false },
      { title: "Étiquetage", desc: "Identifier les câbles", completed: false },
      { title: "Documentation", desc: "Créer schéma câblage", completed: false }
    ]
  },
  'A.7.13': {
    recommendations: [
